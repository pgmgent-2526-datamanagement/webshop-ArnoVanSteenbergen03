...
<body>
    ...
    <div class="content">
        ...
        <div class="customer-info">
            ...
            <p style="margin: 5px 0;"><strong>City:</strong> {{ $customerData['city'] }}</p>
            <p style="margin: 5px 0;"><strong>Zipcode:</strong> {{ $customerData['zipcode'] }}</p>
        </div>
        ...
        <p style="margin-top: 30px; text-align: center;">
            <strong>Order placed on:</strong> {{ $order->created_at->format('d/m/Y H:i') }}
        </p>
    </div>

    <div class="footer">
        <p>This is an automated notification from your webshop.</p>
        <p>&copy; {{ date('Y') }} AVSWebshop Admin Panel.</p>
    </div>
</body>
</html>
