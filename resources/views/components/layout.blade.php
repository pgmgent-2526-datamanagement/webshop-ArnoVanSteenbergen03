		...
		<header class="bg-white/95 backdrop-blur-lg shadow-lg sticky top-0 z-50">
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div class="flex justify-between items-center py-4">
					...
					<button type="button" class="md:hidden inline-flex items-center justify-center p-2 bg-blue-600 rounded-lg focus:outline-none" id="mobile-menu-button">
						<div id="menu-icon" class="w-5 h-4 flex flex-col justify-between">
							<span class="block w-full h-0.5 bg-white rounded"></span>
							<span class="block w-full h-0.5 bg-white rounded"></span>
							<span class="block w-full h-0.5 bg-white rounded"></span>
						</div>
						<svg id="close-icon" class="w-5 h-5 hidden" fill="none" stroke="white" stroke-width="2" viewBox="0 0 24 24">
